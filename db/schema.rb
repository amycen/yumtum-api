...
ActiveRecord::Schema.define(version: 2019_08_11_172148) do
  ...
  create_table "item_alert_notes", force: :cascade do |t|
    t.bigint "item_id"
    t.bigint "alert_note_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["alert_note_id"], name: "index_item_alert_notes_on_alert_note_id"
    t.index ["item_id"], name: "index_item_alert_notes_on_item_id"
  end
  ...
  add_foreign_key "item_alert_notes", "items"
